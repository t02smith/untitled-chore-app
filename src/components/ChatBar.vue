            ...
            <div class="msg-box">
                ...
                <div class="messages">
                    <p class="msg" id="msg-0">
                        The customer is very important, the customer will be followed by the customer. It's a casino, and it's not sad for developers, it's now being implemented, the element is always just hate it.
                    </p>
                </div>
