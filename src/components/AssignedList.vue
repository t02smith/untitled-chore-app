        ...
        <div class="modal fade" id="addChore" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <input v-model="uname" type="text" class="form-control" id="username"
                            placeholder="Put the dishwasher on the fridge">
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
                    </div>
            ...
            <div class="accordion-item">
                <h2 class="accordion-header" id="headingOne">
                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                        ...
                        @click="setCurrUser('Tom')">Tom<button type="button" id="addBut" class="btn btn-light btn-sml"
                            data-bs-toggle="modal" data-bs-target="#addChore"><img src="@/assets/add.png"
                                alt="Image can't be displayed" width="15" height="15"></button>
                    </button>
                </h2>
                <div id="collapseOne" class="accordion-collapse collapse show" aria-labelledby="headingOne"
                    data-bs-parent="#housemates">
                    <div class="accordion-body">
                        <li id="choresList" v-for="chore in currChores">
                            {{ chore }} <button type="button" id="binButton" class="btn btn-light btn-sml"
                                data-bs-toggle="modal" data-bs-target="#deleteChore" @click=deleteChore(chore)><img
                                    src="@/assets/bin.png" alt="Image can't be displayed" width="11"
                                    height="11"></button>
                        </li>
                    </div>
                </div>
            ...
            <div class="accordion-item">
                <h2 class="accordion-header" id="headingTwo">
                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                        ...
                        Chris<button type="button" class="btn btn-light btn-sml" data-bs-toggle="modal"
                            data-bs-target="#addChore" id="addBut"><img src="@/assets/add.png"
                                alt="Image can't be displayed" width="15" height="15"></button>
                    </button>
                </h2>
